#' UF yearly population estimates per sex and age group
#'
#' This function provides a tibble containing population estimates for Brazilian UFs per sex and age groups from 2000 to 2020.
#'
