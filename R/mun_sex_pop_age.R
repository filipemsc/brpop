#' Municipality yearly population estimates per sex and age group
#'
#' This function provides a tibble containing population estimates for Brazilian municipalities per sex and age groups from 2000 to 2020.
#'
...
mun_sex_pop_age <- function(age_group_option = "SVS2"){
